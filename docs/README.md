...
- [Remote access](remote-connect.md) — advanced, explicitly configured staging/self-hosted Connect lifecycle; managed Cloud Connect is currently withheld
- [Connect release status](connect-release-status.md) — immutable package/asset versions and the current launch decision
...
- [OR3 App connection guide](app-connection.md) — pair a local web or desktop app to `or3-intern service`
