...
var runnerFirstPathStatus = map[string]FieldStatus{
	...
	"modelRouting.contextManager.primary.model":    FieldStatusHidden,
	"modelRouting.contextManager.primary.provider": FieldStatusHidden,
	...
	"context.tools.dynamicExpose":                  FieldStatusHidden,
	"context.taskCard.enforcePlan":                 FieldStatusHidden,
	"contextManager.enabled":                       FieldStatusHidden,
	"contextManager.provider":                      FieldStatusHidden,
	"contextManager.model":                         FieldStatusHidden,
	"contextManager.timeoutSeconds":                FieldStatusHidden,
	"contextManager.idlePruneSeconds":              FieldStatusHidden,
	"contextManager.maxInputTokens":                FieldStatusHidden,
	"contextManager.maxOutputTokens":               FieldStatusHidden,
	"contextManager.allowTaskUpdates":              FieldStatusHidden,
	"contextManager.allowStalePropose":             FieldStatusHidden,
