...
func OpenCodeCatalog(ctx context.Context, cfg config.RunnersConfig, env []string) []RunnerModelInfo {
...
func NormalizeOpenCodeModelID(ctx context.Context, cfg config.RunnersConfig, env []string, requested string) string {
...
func OpenCodeCLIModelFlag(ctx context.Context, cfg config.RunnersConfig, env []string, requested string) string {
