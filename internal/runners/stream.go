...
func readStream(r io.Reader, stream string, chunkMaxBytes int, seq *int64, collector *outputCollector, onEvent func(RunnerRunEvent), outputMode OutputMode) {
...
func readStructuredStream(r io.Reader, stream string, chunkMaxBytes int, seq *int64, collector *outputCollector, onEvent func(RunnerRunEvent)) {
	reader := bufio.NewReader(r)
	var pending strings.Builder
...
func emitStreamLine(rawLine, stream string, chunkMaxBytes int, seq *int64, collector *outputCollector, onEvent func(RunnerRunEvent), outputMode OutputMode) {
...
func emitStreamOutputChunks(line, stream string, chunkMaxBytes int, seq *int64, collector *outputCollector, onEvent func(RunnerRunEvent)) {
	if collector != nil {
		switch stream {
		case "stdout":
			collector.stdout.Write([]byte(line))
...
func emitStructuredIfValid(onEvent func(RunnerRunEvent), seq *int64, collector *outputCollector, raw string) bool {
...
func drainStructuredBuffer(pending *strings.Builder, seq *int64, collector *outputCollector, onEvent func(RunnerRunEvent)) bool {
	raw := pending.String()
