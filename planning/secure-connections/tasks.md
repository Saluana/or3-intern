...
- [ ] 1.3 Produce cross-language test vectors before writing production flows.
...
- [ ] 1.5 Schedule external security review for the protocol and implementation plan.
...
- [ ] 2.3 Implement host trust-store service.
...
- [ ] 2.5 Add host identity change protections.
...
- [ ] 3.4 Implement pairing rendezvous endpoints.
...
- [ ] 3.6 Add relay no-plaintext guardrails.
...
- [ ] 4.7 Implement pairing rejection and timeout handling.
...
- [ ] 5.1 Add native device identity generation.
...
- [ ] 5.2 Implement secure-storage capability detection.
...
- [ ] 5.6 Build mobile pairing success, waiting, rejection, and expired states.
...
- [ ] 6.3 Implement secure frame encoding and replay protection.
...
- [ ] 7.5 Add audit events for remote actions.
...
- [ ] 8.1 Bind pairing to the expected OR3 account when available.
    - Include account binding proof in encrypted enrollment proposal and reject mismatched account flows in consumer mode.
    - Requirements: 2, 8, 9

- [ ] 8.2 Preserve passkeys as account and step-up authority only.
...
- [ ] 8.4 Align iOS Associated Domains and Android Digital Asset Links with passkey and app-link flows.
...
- [ ] 10.4 Add mobile lifecycle protections.
...
- [ ] 10.5 Add jailbreak/root/debug signal policy hooks where feasible.
...
- [ ] 11.3 Add web passkey step-up for sensitive actions.
...
- [ ] 12.1 Add capability discovery for secure connections v2.
...
- [ ] 12.3 Restrict six-digit pairing to legacy/local modes.
...
- [ ] 12.4 Remove bearer token authority for remote computer control.
...
- [ ] 12.5 Add migration audit and rollback plan.
...
- [ ] 13.3 Implement revocation propagation and enforcement.
...
- [ ] 13.5 Add account recovery guidance and flows.
...
- [ ] 14.1 Define privacy-preserving telemetry events.
...
- [ ] 14.2 Add secure logging filters.
...
- [ ] 14.3 Add operational dashboards.
...
- [ ] 14.4 Add customer-visible transparency surfaces.
...
- [ ] 15.1 Build cryptographic protocol unit tests.
...
- [ ] 15.4 Build authorization integration tests.
...
- [ ] 15.6 Build Capacitor platform tests.
...
- [ ] 16.1 Prototype the three-step consumer pairing flow.
...
- [ ] 16.4 Add accessibility coverage.
...
- [ ] 16.5 Remove technical language from mainstream UI.
...
- [ ] 17.3 Add developer documentation for secure connection APIs.
...
- [ ] 17.4 Create staged rollout plan.
...
- [ ] 17.5 Define production release gates.
...
- [ ] 17.6 Define legacy deprecation timeline.
